...
public class NewsChannelPresenter extends RxPresenter implements NewsChannelContract.Presenter {
    // 构造接口View实现类
    NewsChannelContract.View mView;


    public NewsChannelPresenter(@NonNull NewsChannelContract.View view){
